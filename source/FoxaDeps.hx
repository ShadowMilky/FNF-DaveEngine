...
/**
 * Foxa Dependencies contains a Script Handler;
 * it handles script-related variables and functions and can be modified as you wish;
 * 
...
class ScriptHandler extends SScript
{
	...
	override public function preset():Void
	{
		...
		// CLASSES (FOREVER);
		set('Main', Main);
		set('FNFSprite', FNFUtils.FNFSprite);

		// CLASSES (FEATHER);
		set('FeatherSprite', FoxaSprite);
